...
class AE(nn.Module):
                        # 500, 500, 1000, 2000, 2000, 1000, 500, 500
    def __init__(self, n_enc_1, n_enc_2, n_enc_3, n_enc_4, n_dec_1, n_dec_2, n_dec_3, n_dec_4,
        ...
        self.enc_4 = Linear(n_enc_3, n_enc_4)
        self.z_layer = Linear(n_enc_4, n_z)
    ...
    def forward(self, x):
        ...
        enc_h4 = F.relu(self.enc_4(enc_h3))
        enc_h4 = self.do(enc_h4)
        z = self.z_layer(enc_h4)

        dec_h1 = F.relu(self.dec_1(z))
        dec_h2 = F.relu(self.dec_2(dec_h1))
        dec_h3 = F.relu(self.dec_3(dec_h2))
        dec_h4 = F.relu(self.dec_4(dec_h3))
        dec_h4 = self.do(dec_h4)
        x_bar = self.x_bar_layer(dec_h4)
        ...
        return x_bar, enc_h1, enc_h2, enc_h3, enc_h4, z, pro_x
...
class SDCN(nn.Module):
    ...
    def __init__(self, n_enc_1, n_enc_2, n_enc_3, n_enc_4, n_dec_1, n_dec_2, n_dec_3, n_dec_4,
        ...
        self.gnn_4 = GNNLayer(n_enc_3, n_enc_4)
        self.gnn_5 = GNNLayer(n_enc_4, n_z)
        self.gnn_6 = GNNLayer(n_z, n_clusters)
    ...
    def forward(self, x, adj):
        # DNN Module
        x_bar, tra1, tra2, tra3, tra4, z, pro_x = self.ae(x)
        ...
        h = self.gnn_5((1-sigma)*h + sigma*tra4, adj,active=False)
        h = self.do(h)
...
def train_sdcn(dataset):
    ...
    file_output = open('../result/' + args.name + '/' + args.name + '_4.txt', 'a+')
    # file_output = open('../result/' + args.name + '/' + args.name + '_pretrain.txt', 'a+')
    model = SDCN(500, 500, 1000, 2000, 2000, 1000, 500, 500,
...
if __name__ == "__main__":
    ...
    for x in range(10):
        ...
        # parser.add_argument('--name', type=str, default='SelfRegulationSCP2')
